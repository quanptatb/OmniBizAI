...
public sealed class FinanceService : IFinanceService
{
    ...
    public FinanceService(IUnitOfWork unitOfWork, IAiCopilotService aiCopilotService, IWorkflowService workflowService, ICurrentUserService currentUserService)
    {
