...
{
    /// <inheritdoc />
    public partial class AddFinanceCoreEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UtilizationPct = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    WarningThreshold = table.Column<decimal>(type: "decimal(5,2)", nullable: false, defaultValue: 80m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Unit = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Item"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_payment_request_items", x => x.Id);
                    table.ForeignKey(
                        name: "FK_payment_request_items_payment_requests_PaymentRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_payment_request_items_PaymentRequestId",
                table: "payment_request_items",
                column: "PaymentRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_payment_requests_RequestNumber",
