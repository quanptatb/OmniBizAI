...
{
    public RealtimeKpiViewModel Kpi { get; set; } = new();
    public OeeChartViewModel Oee { get; set; } = new();
    public List<HeatmapCellViewModel> Heatmap { get; set; } = new();
    public List<GanttTaskViewModel> Gantt { get; set; } = new();
    public List<MonitoringAlertItemViewModel> RecentAlerts { get; set; } = new();
    public MonitoringAlertSendViewModel AlertForm { get; set; } = new();
}

public class RealtimeKpiViewModel
{
    public int TotalRequests { get; set; }
...
public class OeeChartViewModel
{
...
public class HeatmapCellViewModel { public string Label { get; set; } = ""; public int Intensity { get; set; } }
public class GanttTaskViewModel { public string RequestNo { get; set; } = ""; public string Title { get; set; } = ""; public DateOnly StartDate { get; set; } public DateOnly? EndDate { get; set; } public string Status { get; set; } = ""; }
public class MonitoringAlertItemViewModel { public string Title { get; set; } = ""; public string Severity { get; set; } = ""; public DateTimeOffset CreatedAt { get; set; } }

public class MonitoringAlertSendViewModel
{
    public string Title { get; set; } = "";
    public string Message { get; set; } = "";
